...
int main(int argc, char *argv[])
{
  ...
  auto JCS=0.0;    
   ...
   printf("%d     %.3f    %.3f    %.3f    %.3f     %.3f\n",L,JC,U,JS,JK,JCS);
    ...
    //auto sites = S1(N,{"ConserveQNs=",true});
 ...
 // and itinerant fermionic  on 2, 4 ..
   ...
   for(int j=1; j<= N-3; j+=2)
    ...
    //
     /*auto state = InitState(sites);
      for(int i = 1; i <= N; i++)//local
        ...
        if((i == 143)||(i == 145)||(i == 147)||(i == 149)||(i == 151)||(i == 153)||(i == 155)||(i == 157)||(i == 159)||(i == 161)||
           (i == 163)||(i == 165)||(i == 167)||(i == 169)||(i == 171)||(i == 173)||(i == 175)||(i == 177)||(i == 179)||(i == 181)) 
           {  
             println("itinerant Emp ", i); //20 hole
             state.set(i,"Emp");
           }
        else if(i%4 == 1) 
             {
    ...
    sweeps.cutoff() = 1E-10;
    sweeps.niter() = 2;
    sweeps.noise() = 1E-2,1E-3,1E-4,1E-5,1E-6,1E-7,1E-8;
    println(sweeps);
